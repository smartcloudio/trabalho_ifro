...
class Message extends DataClass implements Insertable<Message> {
  ...
  Message copyWith({int id, String title, String content, int category}) =>
      Message(
        id: id ?? this.id,
...
class User extends DataClass implements Insertable<User> {
  ...
  User copyWith({int id, String name, String email, String avatarUrl}) => User(
        id: id ?? this.id,
        name: name ?? this.name,
  ...
  @override
  int get hashCode => $mrjf($mrjc(id.hashCode,
      $mrjc(name.hashCode, $mrjc(email.hashCode, avatarUrl.hashCode))));
  @override
  bool operator ==(dynamic other) =>
      identical(this, other) ||
      (other is User &&
